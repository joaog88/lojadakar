...
import suspensaopagina from "../assets/imgs/suspensaopagina.jpg";
...
export default function Suspensao() {
  ...
  return (
    <div style={{ backgroundColor: "#d9d9d9" }}>
      <div
        style={{
          background: `url(${suspensaopagina}) no-repeat center`,
              ...
              >
                ...
                <Grid item xs={12} style={{ paddingTop: "10px" }}>
                  <a
                    ...
                    href={
                      "https://api.whatsapp.com/send/?phone=5535997658926&text=Olá, gostaria de fazer um orçamento para fazer um serviço na suspensão."
                    }
                  >
                    <Button
                      variant="outlined"
