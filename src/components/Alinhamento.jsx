...
import alinhamentopagina from "../assets/imgs/alinhamentopagina.jpg";
...
export default function Alinhamento() {
  ...
  return (
    <div style={{ backgroundColor: "#d9d9d9" }}>
      <div
        style={{
          background: `url(${alinhamentopagina}) no-repeat center`,
                ...
                <Hidden xsDown>
                  ...
                  <Grid item xs={12} style={{ paddingTop: "10px" }}>
                    <a
                      ...
                      href={
                        "https://api.whatsapp.com/send/?phone=5535998644153&text=Olá, gostaria de fazer um orçamento para fazer um alinhamento."
                      }
                    >
                      <Button
                        variant="outlined"
                ...
                <Hidden smUp>
                  ...
                  <Grid item xs={12} style={{ paddingTop: "10px" }}>
                    <a
                      ...
                      style={{ textDecoration: "none" }}
                      href={
                        "https://api.whatsapp.com/send/?phone=5535997658926&text=Olá, gostaria de fazer um orçamento para fazer um alinhamento."
                      }
                    >
                      <Button
                        variant="outlined"
