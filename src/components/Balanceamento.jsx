...
import balanceamentopagina from "../assets/imgs/balanceamentopagina.jpg";
...
export default function Balanceamento() {
  const ButtonStyle = {
    fontSize: "1.25rem",
    fontWeight: 540,
    textTransform: "none",
  ...
  return (
    <div style={{ backgroundColor: "#d9d9d9" }}>
      <div
        style={{
          background: `url(${balanceamentopagina}) no-repeat center`,
                ...
                <Hidden xsDown>
                  ...
                  <Grid item xs={12} style={{ paddingTop: "10px" }}>
                    <a
                      ...
                      href={
                        "https://api.whatsapp.com/send/?phone=5535998644153&text=Olá, gostaria de fazer um orçamento para fazer um balanceamento."
                      }
                    >
                      <Button
                        variant="outlined"
