...
import escapamentopagina from "../assets/imgs/escapamentopagina.jpg";
...
export default function Escapamento() {
  const ButtonStyle = {
    fontSize: "1.25rem",
    fontWeight: 540,
    textTransform: "none",
  ...
  return (
    <div style={{ backgroundColor: "#d9d9d9" }}>
      <div
        style={{
          background: `url(${escapamentopagina}) no-repeat center`,
              ...
              >
                ...
                <Grid item xs={12} style={{ paddingTop: "10px" }}>
                  <a
                    ...
                    href={
                      "https://api.whatsapp.com/send/?phone=5535997658926&text=Olá, gostaria de fazer um orçamento para fazer um serviço no escapamento."
                    }
                  >
                    <Button
                      variant="outlined"
