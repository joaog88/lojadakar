...
import motorpagina from "../assets/imgs/motorpagina.jpg";
...
export default function Motor() {
  ...
  return (
    <div style={{ backgroundColor: "#d9d9d9" }}>
      <div
        style={{
          background: `url(${motorpagina}) no-repeat center`,
                ...
                <Hidden xsDown>
                  <Grid item xs={12}>
                    <Typography style={EstiloLetraCard}>
                      Agende seu serviço de motor com um de nossos atendentes
                      via:
                    </Typography>
                  </Grid>
                  <Grid item xs={12} style={{ paddingTop: "10px" }}>
                    <a
                      ...
                      href={
                        "https://api.whatsapp.com/send/?phone=5535998644153&text=Olá, gostaria de fazer um orçamento para fazer um serviço de motor."
                      }
                    >
                      <Button
                        variant="outlined"
                ...
                <Hidden smUp>
                  ...
                  <Grid item xs={12} style={{ paddingTop: "10px" }}>
                    <a
                      ...
                      style={{ textDecoration: "none" }}
                      href={
                        "https://api.whatsapp.com/send/?phone=5535997658926&text=Olá, gostaria de fazer um orçamento para fazer um serviço de motor."
                      }
                    >
                      <Button
                        variant="outlined"
